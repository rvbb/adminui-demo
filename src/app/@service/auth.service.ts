...
export class AuthService {
    ...
    doLogin(payload: UserLogin): Observable<UserLoginRespone> {
        ...
        var userAdmin: UserDto = {
            id: "1234354354656",
            role: ROLE_ADMIN,
            loginName: "admin@bankplus.vn",
            fullName: "Hoang N.V",
            email: "admin@bankplus.vn",
            dob: "11/03/1990",
        ...
        var userSupervisor: UserDto = {
            ...
            loginName: "supervisor@bankplus.vn",
            fullName: "Supervisor Ms",
            email: "supervisor@bankplus.vn",
            dob: "10/03/1994",
        ...
        if (payload) {
            ...
            */
            ...
            // for test only
            if (payload.email == "admin@bankplus.vn") {
                result.userDto = userAdmin;
                result.code = 0;
                result.message = "success - admin";
            } else if (payload.email == 'supervisor@bankplus.vn') {
